...
namespace SmartUniversity.Application.Services
{
    public class AssignmentSubmissionService : IAssignmentSubmissionService
    {
        ...
        public AssignmentSubmissionService(
            IAssignmentSubmissionRepository repo,
        ...
        public async Task<IEnumerable<SubmissionDto>>
        GetByAssignmentAsync(int assignmentId)
        {
            var submissions =
                await _repo.GetByAssignmentIdAsync(
                    assignmentId);
        ...
        {
            var submission =
                await _repo.GetByIdAsync(submissionId);
